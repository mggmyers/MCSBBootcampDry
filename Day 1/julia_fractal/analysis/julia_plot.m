...
juliaSet = nmax_complex<22; % Julia set is defined as p values that mapped to infinity (here defined as abs(z)>2).
...
scatter(real(p(juliaSet)), imag(p(juliaSet)), 10, nmax_complex(juliaSet));
colormap(cool);
